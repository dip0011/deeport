        ...
        <ContentContainer>
          <div className="pt-12 pb-20 flex flex-col gap-16">
              ...
              <div className="pl-0 md:pl-11 flex flex-col gap-10">
                ...
                <div>
                  <div className="mb-4">
                    ...
                    <h2 className="font-display text-xl font-semibold text-ink mb-3">Behavior-Based Triggers over Time-Based Jobs</h2>
                    <p className="text-[15px] text-ink-2 leading-relaxed">
                      ...
                      <div className="w-full h-28 bg-transparent mb-8 flex items-center justify-center relative overflow-hidden" style={{ opacity: 0.5 }}>
                        <div className="absolute inset-0 flex items-center justify-center gap-6">
                          <div className="w-10 h-10 rounded border border-rule-strong flex items-center justify-center">
                            <span className="block w-2 h-2 bg-ink rounded-full"></span>
                          </div>
                          <div className="h-px w-6 bg-gradient-to-r from-transparent via-ink to-transparent"></div>
                          <div className="w-10 h-10 rounded-full border-2 border-ink flex items-center justify-center shadow-[0_0_10px_rgba(0,0,0,0.2)]">
                            <span className="block w-3 h-3 bg-ink rounded-full"></span>
                          </div>
                          <div className="h-px w-6 bg-gradient-to-r from-transparent via-ink to-transparent"></div>
                          <div className="w-10 h-10 rounded border border-rule-strong flex items-center justify-center">
                            <span className="block w-2 h-2 bg-ink rounded-full"></span>
                ...
                <div>
                  <div className="mb-4">
                    ...
                    <h2 className="font-display text-xl font-semibold text-ink mb-3">Event-First Data Model</h2>
                    <p className="text-[15px] text-ink-2 leading-relaxed">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-8">
                        <div className="bg-transparent border border-rule rounded p-3 flex flex-col items-center justify-center gap-2" style={{ opacity: 0.5 }}>
                          <span className="text-[10px] uppercase tracking-wider text-ink-muted font-bold">State-based</span>
                          <div className="flex flex-col gap-1 py-2">
                            <div className="w-12 h-8 rounded border border-rule-strong bg-paper-2 flex items-center justify-center text-[8px] text-ink-muted">User</div>
                            <div className="text-[8px] text-ink-muted">Mutable</div>
                          </div>
                          <p className="text-[10px] text-center text-ink-muted">Traditional</p>
                        </div>
                        <div className="bg-transparent border border-ink rounded p-3 flex flex-col items-center justify-center gap-2 relative overflow-hidden">
                          ...
                          <span className="text-[10px] uppercase tracking-wider text-ink font-bold">Event-based</span>
                          <div className="flex flex-col gap-1 py-2">
                            <div className="w-12 h-8 rounded border-2 border-ink bg-paper flex items-center justify-center text-[8px] text-ink">Event</div>
                            <div className="text-[8px] text-ink-muted">Immutable</div>
                          </div>
                          <p className="text-[10px] text-center text-ink-2">Our Approach</p>
                        </div>
                      </div>
            ...
            <section className="py-8">
              ...
              <div className="pl-0 md:pl-11 grid grid-cols-2 gap-6 mb-6">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-ink font-display text-4xl font-semibold tracking-tight">2.5x</p>
                  <p className="text-ink-2 text-sm font-normal">Higher engagement</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="text-xs uppercase tracking-wider text-ink-muted font-medium">TARGETING</div>
                  <p className="text-ink font-display text-4xl font-semibold tracking-tight">40%</p>
                  <p className="text-ink-2 text-sm font-normal">Better targeting</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="text-xs uppercase tracking-wider text-ink-muted font-medium">AUTOMATION</div>
                  <p className="text-ink font-display text-4xl font-semibold tracking-tight">~80%</p>
                  <p className="text-ink-2 text-sm font-normal">Manual work</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="text-xs uppercase tracking-wider text-ink-muted font-medium">SPEED</div>
                  <p className="text-ink font-display text-4xl font-semibold tracking-tight">10x</p>
                  <p className="text-ink-2 text-sm font-normal">Experiment speed</p>
                </div>
              </div>
                ...
                <div className="flex flex-col gap-4 rounded-xl border border-rule bg-paper-2 p-6">
                  <div className="flex justify-between items-end">
                    <div>
                      ...
                      <p className="text-ink text-xl font-medium">Engagement Rate</p>
                    </div>
                    <div className="flex items-center gap-1 bg-ink/10 px-2 py-1 rounded">
                      <span className="text-ink text-xs font-bold">+150% YoY</span>
                    </div>
                  </div>
                  <div className="relative w-full h-[160px] mt-4">
                    <svg className="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 300 100">
                      ...
                      {/* Chart Line */}
                      <path d="M0 90 C 30 90, 40 70, 80 70 C 120 70, 140 40, 180 40 C 220 40, 240 20, 280 15" fill="none" stroke="#1E1B16" strokeLinecap="round" strokeWidth="2"></path>
                      {/* Data Points */}
                      <circle cx="80" cy="70" fill="white" r="3" stroke="#1E1B16" strokeWidth="2"></circle>
                      <circle cx="180" cy="40" fill="white" r="3" stroke="#1E1B16" strokeWidth="2"></circle>
                      <circle cx="280" cy="15" fill="#7A2E2E" r="4"></circle>
                    </svg>
                  </div>
              ...
              <div className="pl-0 md:pl-11 mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 rounded border border-rule bg-paper-2 text-xs text-ink-2">Event Pipeline</span>
                  <span className="px-3 py-1 rounded border border-rule bg-paper-2 text-xs text-ink-2">Dynamic Segmentation</span>
                  <span className="px-3 py-1 rounded border border-rule bg-paper-2 text-xs text-ink-2">Real-time Evaluation</span>
                  <span className="px-3 py-1 rounded border border-rule bg-paper-2 text-xs text-ink-2">Campaign Delivery</span>
                </div>
              </div>
            </section>
            ...
            <div className="flex justify-between items-center pt-12 border-t border-rule mt-12">
              <Link href="/case-study/techmonk" className="flex items-center gap-2 text-ink-2 hover:text-accent transition-colors">
                <span>←</span>
                Previous Project
              </Link>
